; ModuleID = '..\benchmark\build\optimize_lreal-O1\output.ll'
...
end_while:                                        ; preds = %while_do, %entry
  ...
  %43 = fmul double %square.i6, 6.000000e+00
  %44 = fmul double %x2.alloca.0.lcssa, %43
  %45 = fsub double %square.i6, %44
  %46 = fmul double %x1.alloca.0.lcssa, 2.000000e+01
  %47 = fsub double %45, %46
  %square1.i7 = fmul double %x2.alloca.0.lcssa, %x2.alloca.0.lcssa
  %48 = fmul double %square1.i7, 3.000000e+00
  %49 = fadd double %48, %47
  %50 = tail call double @llvm.pow.f64(double %x1.alloca.0.lcssa, double 4.000000e+00)
  %51 = fmul double %50, 3.000000e+00
  %52 = fadd double %51, %49
  %53 = fadd double %52, 1.090000e+02
  ret double %53
}
